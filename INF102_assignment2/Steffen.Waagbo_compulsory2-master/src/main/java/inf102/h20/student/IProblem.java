...
public interface IProblem {
	 ...
	 * 1.	The point need to be adjacent to a power line such that a failure of that power line would cause
	 ...
	 * @param u,v - the two points with no power.
	 * @return the best point to search for the power outage.
	 */
	public <T> T lca(Graph<T> g, T root, T u, T v);
	
	/**
	 * The power company need to add one new power line to mitigate large power outages.
